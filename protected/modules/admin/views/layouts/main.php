...
<html lang="<?php echo Yii::app()->language; ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/selectize.css">
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/vendor/bootstrap-table/bootstrap-table.min.css">   
    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <?php
                            $link_to_url = '/' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/' . Yii::app()->controller->defaultAction;

                            switch (Yii::app()->language) {
                                case 'uz':
                                    echo '<li class="nav-item no-arrow mx-1 font-weight-bolder">' . CHtml::link('UZ', '/uz' . $link_to_url, ['class' => 'nav-link text-primary']) . '</li>';
                                    echo '<li class="nav-item no-arrow mx-1">' . CHtml::link('УЗ', '/oz' . $link_to_url, ['class' => 'nav-link']) . '</li>';
                                    echo '<li class="nav-item no-arrow mx-1">' . CHtml::link('RU', '/ru' . $link_to_url, ['class' => 'nav-link']) . '</li>';
                                    break;
                                case 'oz':
                                    echo '<li class="nav-item no-arrow mx-1">' . CHtml::link('UZ', '/uz' . $link_to_url, ['class' => 'nav-link']) . '</li>';
                                    echo '<li class="nav-item no-arrow mx-1 font-weight-bolder">' . CHtml::link('УЗ', '/oz' . $link_to_url, ['class' => 'nav-link text-primary']) . '</li>';
                                    echo '<li class="nav-item no-arrow mx-1">' . CHtml::link('RU', '/ru' . $link_to_url, ['class' => 'nav-link']) . '</li>';
                                    break;
                                case 'ru':
                                    echo '<li class="nav-item no-arrow mx-1">' . CHtml::link('UZ', '/uz' . $link_to_url, ['class' => 'nav-link']) . '</li>';
                                    echo '<li class="nav-item no-arrow mx-1">' . CHtml::link('УЗ', '/oz' . $link_to_url, ['class' => 'nav-link']) . '</li>';
                                    echo '<li class="nav-item no-arrow mx-1 font-weight-bolder">' . CHtml::link('RU', '/ru' . $link_to_url, ['class' => 'nav-link text-primary']) . '</li>';
                                    break;
                                default:
                                    break;
                            }
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; <a href="http://magicmedia.uz/" target="blank">Magic Media</a> 2019</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/bootstrap-table/bootstrap-table.min.js"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/bootstrap-table/locale/bootstrap-table-ru-RU.min.js"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/bootstrap-table/extensions/export/bootstrap-table-export.min.js"></script>
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/selectize.min.js"></script>
    </body>
</html>